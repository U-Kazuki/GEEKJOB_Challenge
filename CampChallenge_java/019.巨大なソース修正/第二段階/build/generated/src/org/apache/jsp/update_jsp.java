...
public final class update_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    Calendar cal = (Calendar)hs.getAttribute("cal");
      ...
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("    <form action=\"UpdateResult\" method=\"get\">\n");
      out.write("        名前:\n");
 ...
 for(int i=1950; i<=2010; i++){ 
      out.write("    \n");
      out.write("            <!--　if文でfor文の値と同じならselectする。その結果をselectedする。-->\n");
...
if(i == udd.getType()){
      ...
      out.write("    </form>\n");
      out.write("        <form action = \"ResultDetail\" method = \"get\">\n");
      out.write("            <input type = \"hidden\" name = \"id\" value = \"");
      out.print( udd.getUserID() );
      out.write("\">\n");
      out.write("            <input type = \"submit\" value = \"詳細画面へ戻る\">\n");
      out.write("        </form>\n");
      out.write("        <br>\n");
      out.write("        ");
      out.print(jh.home());
