...
public final class searchresult_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    List<UserDataDTO> udd = (ArrayList<UserDataDTO>)request.getAttribute("resultData");
      ...
      out.write("            </tr>\n");
      out.write("            <tr>\n");
      out.write("            <!--値を何も受け取らなかった場合は全権表示させる-->\n");
      out.write("            ");
 for(UserDataDTO val : udd){ 
      out.write("\n");
      out.write("                <td><a href=\"ResultDetail?id=");
      out.print( val.getUserID());
      out.write('"');
      out.write('>');
      out.print( val.getName());
      out.write("</a></td>\n");
      out.write("                <td>");
      out.print( val.getBirthday());
      out.write("</td>\n");
      out.write("                <!--　JumsHelperにコードが書かれているので、参照先はjhのメソッドexTypenum(にuddから取得したint型のType)を入れます。　-->\n");
      out.write("                <td>");
      out.print( jh.exTypenum(val.getType()) );
      out.write("</td>\n");
      out.write("                <td>");
      out.print( val.getNewDate());
      out.write("</td>\n");
      out.write("            </tr>\n");
      out.write("            ");
}
